...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pixels — Play, build, and earn $PIXEL." },
      { name: "description", content: "Pixels Hub is the player home of the Pixels world. Pixels Studio is where creators build the games. One account, one $PIXEL wallet on Ronin." },
      { name: "author", content: "Pixels" },
      { name: "theme-color", content: "#F0EDFF" },
      { property: "og:site_name", content: "Pixels" },
      { property: "og:title", content: "Pixels — Play, build, and earn $PIXEL" },
      { property: "og:description", content: "Play games in Pixels Hub, build them in Pixels Studio. Earn $PIXEL on Ronin, powered by Stacked quests." },

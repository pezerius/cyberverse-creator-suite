...
export const notifications: Notif[] = [
  ...
  { id: "n4", kind: "trending", title: "Your game hit the trending shelf", body: "Neon Rush is #7 in Racing this week.", when: "3h ago", unread: true, href: "/dashboard" },
  { id: "n5", kind: "comment", title: "New comment on Neon Rush", body: "@zap: 'Boss fight in stage 3 is unreal'", when: "5h ago", href: "/dashboard" },
